        ...
        <div class="d-flex justify-content-center h-100">
            <div class="user_card">
                ...
                if(isset($_GET['registered']))
                {
                    ...
                    <?php
                } else if(isset($_GET['length_error'])) {
                    ?>
                    <span class="bg-white text-danger text-center my-3"> Contact number must be 10 digits! </span>
                    <?php
                }
                ?>
...
if(isset($_POST['sign_up_btn']))
{
    ...
    if(strlen($su_contact_no) === 10) {
        ...
        ?>
        <script> location.assign("index.php?sign-up=1&invalid=1&length_error=1"); </script>
        <?php
    }
} else if(isset($_POST['loginBtn']))
{
    ...
    if(strlen($contact_no) === 10) {
        ...
        // Redirect with an error message
        ?>
        <script> location.assign("index.php?length_error=1"); </script>
        <?php
    }
}
?>
